...
main (int argc, char *argv[])
{
  ...
  consumerHelper.SetAttribute ("NumberOfContents", StringValue ("70"));
  ...
  //Simulator::Schedule (Seconds (1), PeriodicStatsPrinter, nodes.Get (5), Seconds (10));
  //Simulator::Schedule (Seconds (1), PeriodicStatsPrinter, nodes.Get (3), Seconds (10));
