...
main (int argc, char *argv[])
{
  ...
  Simulator::Schedule (Seconds (5.0), ndn::LinkControlHelper::FailLink, nodes.Get (1), nodes.Get (2));
  Simulator::Schedule (Seconds (10.0), ndn::LinkControlHelper::UpLink,   nodes.Get (1), nodes.Get (2));
  //Simulator::Schedule (Seconds (5.0), ndn::LinkControlHelper::UpLink,   nodes.Get (1), nodes.Get (2));
