...
#define Strategy	"Popcacherevise"
...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("topology/topo-6-level-4k-tree.txt");
  topologyReader.Read ();
  
  // Install NDN stack on all nodes
  ndn::StackHelper ndnHelper;
  ndnHelper.SetDefaultRoutes (true);
  ndnHelper.SetForwardingStrategy ("ns3::ndn::fw::Popcacherevise");
  ...
  producerHelper.SetAttribute ("PayloadSize", StringValue("1028"));
  producerHelper.SetPrefix ("/prefix");
  ndnGlobalRoutingHelper.AddOrigins ("/prefix", producers[0]);
  producerHelper.Install (producers[0]); // root node
  
  // Consumer
  Ptr<Node> consumers[57] = { 	Names::Find<Node> ("R1111"),  Names::Find<Node> ("R1112"),  Names::Find<Node> ("R1113"),
				...
				Names::Find<Node> ("R3224"),  Names::Find<Node> ("R34"),    Names::Find<Node> ("R3312"),
