...
// Set Producer
  ...
  ndn::L3AggregateTracer::InstallAll ("result/aggregate-trace-10-0.6.txt", Seconds (1.0));
  ndn::L3RateTracer::InstallAll ("result/rate-trace-10-0.6.txt", Seconds (1.0));
  ndn::CsTracer::InstallAll ("result/cs-trace-10-0.6.txt", Seconds (1));
  ndn::AppDelayTracer::InstallAll ("result/app-delays-trace-10-0.6.txt");
  L2RateTracer::InstallAll ("result/drop-trace-10-0.6.txt", Seconds (1.0));
