...
main (int argc, char *argv[])
{
 ...
 // p2p.Install (nodes.Get (8), nodes.Get (9));
  ...
  ndnHelper.SetContentStore ("ns3::ndn::cs::Lru",
                              "MaxSize", "100");
  //ndnHelper.SetForwardingStrategy ("ns3::ndn::fw::NoCatchStorage");
 ...
 // ndn::AppHelper consumerHelper ("ns3::ndn::ConsumerCbr");
  ...
  // Consumer will request /prefix/1, /prefix/1, ...
 ...
 // boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::AppDelayTracer> > >
  ndn::AppDelayTracer::InstallAll ("./result/line-lru-LCD-app-delays-trace.txt");
