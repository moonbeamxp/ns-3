...
#define Strategy	"P2PRoute"
#define CS_Capacity	"500"
...
main (int argc, char *argv[])
{
  ...
  // Define Router
  Ptr<Node> routers[33] = {	Names::Find<Node> ("1"),	Names::Find<Node> ("3"),	Names::Find<Node> ("5"),
  ...
  // Define Consumer
  Ptr<Node> consumers[66] = {	Names::Find<Node> ("2"),	Names::Find<Node> ("4"),	Names::Find<Node> ("6"),
  				Names::Find<Node> ("8"), 	Names::Find<Node> ("10"), 	Names::Find<Node> ("12"),
				Names::Find<Node> ("14"), 	Names::Find<Node> ("16"),   	Names::Find<Node> ("18"),
				Names::Find<Node> ("20"), 	Names::Find<Node> ("22"), 	Names::Find<Node> ("24"),
				Names::Find<Node> ("26"), 	Names::Find<Node> ("28"), 	Names::Find<Node> ("30"),
				Names::Find<Node> ("32"), 	Names::Find<Node> ("34"), 	Names::Find<Node> ("36"),
				Names::Find<Node> ("38"), 	Names::Find<Node> ("40"), 	Names::Find<Node> ("42"),
				Names::Find<Node> ("44"), 	Names::Find<Node> ("46"),  	Names::Find<Node> ("48"),
				Names::Find<Node> ("50"), 	Names::Find<Node> ("52"), 	Names::Find<Node> ("54"),
				Names::Find<Node> ("56"), 	Names::Find<Node> ("58"), 	Names::Find<Node> ("60"),
				Names::Find<Node> ("62"), 	Names::Find<Node> ("64"), 	Names::Find<Node> ("66"),
				Names::Find<Node> ("68"),	Names::Find<Node> ("70"), 	Names::Find<Node> ("72"),
				Names::Find<Node> ("74"),	Names::Find<Node> ("76"),	Names::Find<Node> ("78"),
				Names::Find<Node> ("80"),	Names::Find<Node> ("82"),	Names::Find<Node> ("84"),
				Names::Find<Node> ("86"),	Names::Find<Node> ("88"),	Names::Find<Node> ("90"),
				Names::Find<Node> ("92"),	Names::Find<Node> ("94"),	Names::Find<Node> ("96"),
				Names::Find<Node> ("98"),
  ...
  ndnHelper.SetForwardingStrategy ("ns3::ndn::fw::P2PRoute");
  ...
  ndnHelper.SetContentStore ("ns3::ndn::cs::Lru","MaxSize", CS_Capacity);  //consumer nodes install cache
  for(int i=0; i<=65; i++)
  {
