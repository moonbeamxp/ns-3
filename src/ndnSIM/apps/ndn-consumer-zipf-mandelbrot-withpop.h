...
#ifndef NDN_CONSUMER_ZIPF_MANDELBROT_WITHPOP_H_
#define NDN_CONSUMER_ZIPF_MANDELBROT_WITHPOP_H_
 ...
 */
class ConsumerZipfMandelbrotwithPop: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfMandelbrotwithPop ();
  virtual ~ConsumerZipfMandelbrotwithPop ();
...
#endif /* NDN_CONSUMER_ZIPF_MANDELBROT_WITHPOP_H_ */
