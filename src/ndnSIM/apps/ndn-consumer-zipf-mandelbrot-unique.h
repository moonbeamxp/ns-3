...
#ifndef NDN_CONSUMER_ZIPF_MANDELBROT_UNIQUE_H_
#define NDN_CONSUMER_ZIPF_MANDELBROT_UNIQUE_H_
 ...
 */
class ConsumerZipfMandelbrotUnique: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfMandelbrotUnique ();
  virtual ~ConsumerZipfMandelbrotUnique ();
...
#endif /* NDN_CONSUMER_ZIPF_MANDELBROT_UNIQUE_H_ */
