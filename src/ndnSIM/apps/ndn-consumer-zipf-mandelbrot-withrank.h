...
#ifndef NDN_CONSUMER_ZIPF_MANDELBROT_WITHRANK_H_
#define NDN_CONSUMER_ZIPF_MANDELBROT_WITHRANK_H_
 ...
 */
class ConsumerZipfMandelbrotwithRank: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfMandelbrotwithRank ();
  virtual ~ConsumerZipfMandelbrotwithRank ();
...
#endif /* NDN_CONSUMER_ZIPF_MANDELBROT_WITHRANK_H_ */
