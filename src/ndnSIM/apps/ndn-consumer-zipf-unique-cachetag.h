...
#ifndef NDN_CONSUMER_ZIPF_UNIQUE_CACHETAG_H_
#define NDN_CONSUMER_ZIPF_UNIQUE_CACHETAG_H_
 ...
 */
class ConsumerZipfUniqueCachetag: public ConsumerCbr
{
public:
   ...
   */
  ConsumerZipfUniqueCachetag ();
  virtual ~ConsumerZipfUniqueCachetag ();
...
#endif /* NDN_CONSUMER_ZIPF_UNIQUE_CACHETAG_H_ */
