...
public:
  ...
  /**
   * @brief Set PST class and its attributes
   * @param pstClass string, representing class of PST, zhi add
   */
  void
  SetPst (const std::string &pstClass,
          const std::string &attr1 = "", const std::string &value1 = "",
          const std::string &attr2 = "", const std::string &value2 = "",
          const std::string &attr3 = "", const std::string &value3 = "",
          const std::string &attr4 = "", const std::string &value4 = "");
...
private:
  ...
  ObjectFactory m_pstFactory;           // PST Objcect, zhi add
